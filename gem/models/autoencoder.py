...
from gem.modules.autoencoding.regularizers import AbstractRegularizer
from gem.modules.ema import LitEma
from gem.util import default, get_obj_from_str, instantiate_from_config
...
class AbstractAutoencoder(LightningModule):
    ...
    def apply_ckpt(self, ckpt: Union[None, str, dict]):
        if ckpt is None:
            ...
            ckpt = {
                "target": "gem.modules.checkpoint.CheckpointEngine",
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            ...
            decoder_config={
                "target": "gem.modules.diffusionmodules.model.Decoder",
                "params": ddconfig,
            },
            **kwargs,
        )
